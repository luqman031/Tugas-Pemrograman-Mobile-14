...
//  ]); // setting app to portrait mode only
  runApp(MyApp());
}
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        appBarTheme: AppBarTheme(
          textTheme: ThemeData.light().textTheme.copyWith(
                // and one for the rest of the app
                title: TextStyle(
                  fontFamily: 'Open Sans',
                  fontSize: 20,
                  fontWeight: FontWeight.bold,
...
//    )
  ...
  void _addNewTransaction(
    ...
    final newTx = Transaction(
        ...
        date: chosenDate,
        id: DateTime.now()
            .toString() // random id created with the date to string
        );
...
//    HapticFeedback.vibrate();
    showModalBottomSheet(
        ...
        }); // you get the context object dynamically put into the builder
  }
            ...
            trailing: Row(
              ...
              children: <Widget>[
                GestureDetector(
                  ...
                  onTap: () => _startToAddNewTransaction(context),
                )
              ],
            ),
          )
